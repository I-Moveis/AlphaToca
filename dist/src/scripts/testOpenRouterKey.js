...
async function main() {
    ...
    const messages = [
        new messages_1.SystemMessage("Responda em português, no máximo 20 palavras."),
        new messages_1.HumanMessage("Qual o significado de alugar um imóvel no I-Moveis?"),
    ];
