 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.post('/support/tickets', supportTicketController_1.supportTicketController.create);
/**
 ...
 */
router.get('/support/tickets', supportTicketController_1.supportTicketController.listForUser);
/**
 ...
 */
router.get('/support/tickets/:id/messages', supportTicketController_1.supportTicketController.getMessages);
/**
 ...
 * Acesso: opener do ticket ou admin.
 */
router.post('/support/tickets/:id/messages', supportTicketController_1.supportTicketController.sendMessage);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.get('/admin/support/tickets', adminOnly, supportTicketController_1.supportTicketController.listForAdmin);
/**
 * @swagger
 ...
 *               $ref: '#/components/schemas/ErrorResponse'
 */
router.put('/admin/support/tickets/:id', adminOnly, supportTicketController_1.supportTicketController.updateForAdmin);
