 ...
 */
router.post('/visits', visitController_1.visitController.create);
/**
 * @swagger
 * /visits:
 *   get:
 ...
 */
router.get('/visits', visitController_1.visitController.list);
/**
 * @swagger
 * /visits/availability:
 *   get:
 ...
 *       404: { description: Propriedade não encontrada }
 */
router.get('/visits/availability', visitController_1.visitController.availability);
/**
 * @swagger
 * /visits/{id}:
 *   get:
 ...
 */
router.get('/visits/:id', visitController_1.visitController.getById);
/**
 * @swagger
 * /visits/{id}:
 *   patch:
 ...
 */
router.patch('/visits/:id', visitController_1.visitController.update);
/**
 * @swagger
 * /visits/{id}:
 *   delete:
 ...
 *       404: { description: Visita não encontrada }
 */
router.delete('/visits/:id', visitController_1.visitController.cancel);
