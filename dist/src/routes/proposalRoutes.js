 ...
 */
router.post('/proposals', proposalController_1.proposalController.create);
/**
 * @swagger
 * /proposals:
 *   get:
 ...
 *                 $ref: '#/components/schemas/Proposal'
 */
router.get('/proposals', proposalController_1.proposalController.list);
/**
 * @swagger
 * /proposals/{id}:
 *   get:
 ...
 */
router.get('/proposals/:id', proposalController_1.proposalController.getById);
/**
 * @swagger
 * /proposals/{id}/status:
 *   patch:
 ...
 *         description: Proposta não encontrada
 */
router.patch('/proposals/:id/status', proposalController_1.proposalController.updateStatus);
