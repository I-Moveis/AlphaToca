 ...
 */
router.get('/notifications/unread-count', notificationController_1.notificationController.unreadCount);
/**
 * @swagger
 * /notifications:
 *   get:
 ...
 *         description: Notificação não encontrada
 */
router.put('/notifications/:id/read', notificationController_1.notificationController.markAsReadIdempotent);
