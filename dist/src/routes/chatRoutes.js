 ...
 */
router.post('/chat/sessions', chatController_1.chatController.getOrCreateSession);
/**
 * @swagger
 * /chat/sessions:
 *   get:
 ...
 */
router.get('/chat/sessions', chatController_1.chatController.listSessions);
/**
 * @swagger
 * /chat/sessions/{id}:
 *   get:
 ...
 */
router.get('/chat/sessions/:id', chatController_1.chatController.getSession);
/**
 * @swagger
 * /chat/messages:
 *   post:
 ...
 */
router.post('/chat/messages', chatController_1.chatController.sendMessage);
/**
 * @swagger
 ...
 */
router.patch('/chat/sessions/:id/status', chatController_1.chatController.updateStatus);
