...
async function handleVisitReminderFromKafka(payload: EachMessagePayload): Promise<void> {
  ...
  try {
    ...
    /**
     * TODO: Implementar lógica de processamento de visitasexemplo de busca de visitações que expiram em windowHours
     * 1. Buscar visitas que estão em windowHours para expirar
     * 2. Enviar notificações para landlords
     * 3. Persistir status de notificação
     */
...
/**
 * Retorna se o consumer está rodando
 */
